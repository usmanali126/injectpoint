                        ...
                        <div class="col-lg-6">
                            ...
                            <form class="form-horizontal" id="uc" role="form" method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input required="" form="uc" type="text" class="form-control" name="uc_name" id="uc_name" placeholder="Union Council Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="uc_no" class="col-sm-4 control-label">Union Council Number</label>
                                    <div class="col-sm-8">
                                        <input required=""  form="uc" type="number" class="form-control" name="uc_number" id="uc_no" placeholder="Union Council Number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="uc_tehsil" class="col-sm-4 control-label">Union Council Tehsil</label>
                                    <div class="col-sm-8">
                                        <input required="" form="uc" type="text" class="form-control" name="uc_tehsil" id="uc_no" placeholder="Tehsil Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
