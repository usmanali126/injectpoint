                            ...
                            <div class="col-lg-5">
                                ...
                                <form class="form-horizontal" id="area" role="form" method="POST" action="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select form="area" id="uc_name" name="uc_name" required="" class="form-control">
                                                <option disabled="" value="" selected="">Select Uc Name</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input required="" form="area" type="text" class="form-control" name="area_name" id="area_name" placeholder="Union Council Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="area_no" class="col-sm-5 control-label">Area Number</label>
                                        <div class="col-sm-7">
                                            <input required="" form="area" type="number" class="form-control" name="area_number" id="area_no" placeholder="Union Council Number">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="area_hw" class="col-sm-5 control-label">Vaccinator Name</label>
                                        <div class="col-sm-7">
